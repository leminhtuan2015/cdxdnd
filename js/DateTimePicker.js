...
}(function ($) 
{
	...
	var defaults = 
	{
		...
		shortDayNames: ["Chủ nhật", "Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7"],
		fullDayNames: ["Chủ nhật", "Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7"],
		shortMonthNames: ["tháng 1", "tháng 2", "tháng 3", "tháng 4", "tháng 5", "tháng 6", "tháng 7", "tháng 8", "tháng 9", "tháng 10", "tháng 11", "tháng 12"],
		fullMonthNames: ["tháng 1", "tháng 2", "tháng 3", "tháng 4", "tháng 5", "tháng 6", "tháng 7", "tháng 8", "tháng 9", "tháng 10", "tháng 11", "tháng 12"],
		formatHumanDate: function(sDate) 
		{
			return sDate.dayShort + ", ngày " + sDate.dd + " " + sDate.month + " , " + sDate.yyyy;
		},
	
		minuteInterval: 1,
		roundOffMinutes: true,
	
		titleContentDate: "Chọn ngày tháng năm sinh",
		titleContentTime: "Chọn thời gian",
		titleContentDateTime: "Chọn ngày tháng và thời gian",
	
		buttonsToDisplay: ["HeaderCloseButton", "SetButton", "ClearButton"],
		setButtonContent: "Lưu",
		clearButtonContent: "Huỷ",
